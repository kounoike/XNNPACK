    ...
    const union xnn_qs8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_DISABLE_TSAN XNN_DISABLE_MSAN
{
  ...
  do {
    v128_t vacc0x0 = wasm_f32x4_replace_lane(wasm_i32x4_const_splat(0), 0, ((const float*) w)[0]);
    v128_t vacc0x1 = wasm_f32x4_replace_lane(wasm_i32x4_const_splat(0), 0, ((const float*) w)[1]);
    v128_t vacc0x2 = wasm_f32x4_replace_lane(wasm_i32x4_const_splat(0), 0, ((const float*) w)[2]);
    v128_t vacc0x3 = wasm_f32x4_replace_lane(wasm_i32x4_const_splat(0), 0, ((const float*) w)[3]);
